...
@WebServlet(name = "ViewPackets", urlPatterns = {"/packets"})
public class ViewPackets extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("</table>");
        out.println("<div class='button-container'><a class='button' href='./SellerPage.html'>Go back</a></div>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
