...
@WebServlet(name = "ViewAllCustomersSellerServlet", urlPatterns = {"/viewallcustomersseller"})
public class ViewAllCustomersSellerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        displayAllCustomers(request, response, emailCookie);
    }

    private void displayAllCustomers(HttpServletRequest request, HttpServletResponse response, String emailCookie)
            throws ServletException, IOException {
