...
public class ViewProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (email != null) {
            ResultSet userData = DatabaseManager.getUserDetailsByEmail(email);
            ...
            response.getWriter().println("<title>User Profile</title>");
            ...
            response.getWriter().println("<div class=\"user-name\">" + email + "</div>");
            ...
            response.getWriter().println("No email cookie found");
        }
    }
}
