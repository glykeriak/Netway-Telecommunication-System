...
@WebServlet(name = "ViewClientPackets", urlPatterns = {"/clientpackets"})
public class ViewClientPackets extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<div id=\"user-name\" class=\"user-name\">Welcome, " + emailCookie + "</div>");
        ...
        out.print("</table>");
        out.println("<div class='button-container'><a class='button' href='./ClientPage.html'>Go back</a></div>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
